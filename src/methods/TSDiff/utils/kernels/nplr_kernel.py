...
from .kernel_utils import power, _conj, _resolve_conj, contract, contract_expression, _c2r, _r2c, OptimModule, has_cauchy_extension, has_pykeops

if has_cauchy_extension:
    from extensions.cauchy.cauchy import cauchy_mult

if has_pykeops:
    from .kernel_utils import cauchy_conj
else:
    from .kernel_utils import cauchy_naive
